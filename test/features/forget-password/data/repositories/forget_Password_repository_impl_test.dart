...
import 'package:elevate_flower_app/features/forget_password/data/repositories/forget_Password_repository_impl.dart';
...
void main() {
  ...
  setUpAll(() {
    ...
    // Also register a dummy for the mapped Entity type returned by the repository
